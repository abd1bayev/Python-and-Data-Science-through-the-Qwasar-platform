...
def transform(html_repos):
    ...
    for row in html_repos:
        ...
        try:
            deverloper_name = row.select_one("img.avatar.mb-1.avatar-user")['alt']
        except:
            deverloper_name = " None name "
        result.append({'deverloper': deverloper_name, 'repository_name': repository_name, 'nbr_stars': number_stars})
    return result
